...
const btnUnaCopy = document.getElementById("copy-unary");
...
btnUnaCopy?.addEventListener("click", handleCopyUnary);
...
function validateUnary() {
  ...
  if (conv.validateBinary(binValue)) {
    ...
    btnUnaCopy.classList.remove("disabled");
    ...
    btnUnaCopy.classList.add("disabled");
...
function validateBinary1() {
  ...
  if (conv.validateBinary(binValue)) {
    ...
    btnBinCopy.classList.remove("disabled");
    ...
    btnBinCopy.classList.add("disabled");
